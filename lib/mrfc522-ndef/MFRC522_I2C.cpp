 ...
 */
MFRC522::StatusCode MFRC522::PCD_CalculateCRC(byte *
 ...
 * @return STATUS_OK on success, STATUS_??? otherwise.
 */
MFRC522::StatusCode MFRC522::PCD_CommunicateWithPICC(byte
 ...
 * @return STATUS_OK on success, STATUS_??? otherwise.
 */
MFRC522::StatusCode MFRC522::PICC_REQA_or_WUPA(byte
 ...
 * @return STATUS_OK on success, STATUS_??? otherwise.
 */
MFRC522::StatusCode MFRC522::PICC_Select(Uid *
    ...
    while(!uidComplete) {
        ...
        while(!selectDone) {
            ...
            if(result == STATUS_COLLISION) {  // More than one PICC in the field => collision.
                regval = PCD_ReadRegister(CollReg); // CollReg[7..0] bits are: ValuesAfterColl reserved CollPosNotValid CollPos[4:0]
                if(regval & 0x20) {  // CollPosNotValid
                    return STATUS_COLLISION; // Without a valid collision position we cannot continue
                }
                byte collisionPos = regval & 0x1F; // Values 0-31, 0 means bit 32.
                if(collisionPos == 0) {
                    collisionPos = 32;
                }
 ...
 * @return STATUS_OK on success, STATUS_??? otherwise.
 */
MFRC522::StatusCode MFRC522::MIFARE_Read(byte
 ...
 * @return STATUS_OK on success, STATUS_??? otherwise.
 */
MFRC522::StatusCode MFRC522::MIFARE_Write(byte
 ...
 * @return STATUS_OK on success, STATUS_??? otherwise.
 */
MFRC522::StatusCode MFRC522::PCD_MIFARE_Transceive(byte *
 ...
 */
void MFRC522::PICC_DumpToSerial(const Uid & uid ///< Pointer to Uid struct returned from a successful PICC_Select().
                               )
{
    MIFARE_Key key;
 ...
 * On success the PICC is halted after dumping the data.
 */
void MFRC522::PICC_DumpMifareClassicToSerial(const Uid &
 ...
 */
void MFRC522::PICC_DumpMifareClassicSectorToSerial(const Uid &
                                                   uid,         ///< Pointer to Uid struct returned from a successful PICC_Select().
 ...
 */
void MFRC522::MIFARE_SetAccessBits(byte *
